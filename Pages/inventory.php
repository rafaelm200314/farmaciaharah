...
// Retrieve employee name from the session
...
<head>
    ...
    <link rel="stylesheet" href="../Pages/assets/css/stock.css">
</head>
...
<body id="page-top">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div id="medicineGrid" class="grid-container">
                        <!-- No Stocks message will be displayed here if there are no stocks available -->
                    </div>
                    <!-- End of Medicine Grid Container -->
                </div>
    ...
    <script src="../Pages/assets/js/stock.js" defer></script>
