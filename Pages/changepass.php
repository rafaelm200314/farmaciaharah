...
// Get employee name and email from session
...
<head>
    ...
    <link rel="stylesheet" href="../Pages/assets/css/pass.css">
    <script src="../Pages/assets/js/change_pass.js" defer></script>
            ...
            <div id="content">
                ...
                <main class="page hire-me-page">
                    <section class="portfolio-block hire-me">
                        <div class="container">
                            <div class="heading">
                                <h2 style="margin: 15px;">Change Password</h2>
                                <form id="changePasswordForm" action="change.php" method="post" class="border rounded border-0 shadow-lg p-3 p-md-5" data-bs-theme="light">
                                    <div class="mb-3">
                                        <label class="form-label" for="email">Email</label>
                                        <!-- Display email from session and make it readonly -->
                                        <input type="text" class="form-control" id="email" name="email" value="<?php echo htmlspecialchars($_SESSION['email']); ?>" readonly>
                                    </div>
                                    ...
                                    <div class="mb-3 password-container">
                                        ...
                                        <input id="newpassword" class="form-control" type="password" name="newpassword" required minlength="8">
                                        <!-- Button to toggle visibility of password -->
                                        <i class="fas fa-eye toggle-password"></i>
                                    </div>
                                    <div class="mb-3 password-container">
                                        ...
                                        <input id="confirm" class="form-control" type="password" name="confirm" required minlength="8">
                                        <!-- Button to toggle visibility of password -->
                                        <i class="fas fa-eye toggle-password"></i>
                                    </div>
                                    <div class="mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-xl-12 offset-xl-0 button"><button class="btn btn-primary d-block w-100" type="submit">Change Password</button></div>
                                        </div>
                                    </div>
                                </form>
