...
if (isset($_GET['supplier_id'])) {
    ...
    $sql = "SELECT supplier_id, supplier_name, supplier_contact, supplier_address FROM supplier_table WHERE supplier_id = $supplier_id";
} else {
    $sql = "SELECT supplier_id, supplier_name, supplier_contact, supplier_address FROM supplier_table";
}
                            ...
                            <section class="portfolio-block hire-me">
                                <div class="container">
                                    <div class="heading" style="text-align: center;">
                                        <h2 style="color: black;">Medicine Form</h2>
                                    </div>
                                    <!-- Medicine Form -->
                                    <form class="border rounded border-0 shadow-lg p-3 p-md-5" data-bs-theme="light" onsubmit="addMed(event)" method="POST" enctype="multipart/form-data">
                                        <!-- Form fields for adding medicine -->
                                        <div class="mb-3"><label class="medName" for="medName">Name</label><input class="form-control" type="text" id="medicineName" name="medicineName" required></div>
                                        <div class="mb-3"><label class="medPrice" for="medPrice">Price</label><input class="form-control" type="number" step="0.01" id="medicinePrice" name="medicinePrice" required></div>
                                        <div class="mb-3"><label class="medExpiry" for="medExpiry">Expiry</label><input class="form-control" type="date" id="medicineExpiry" name="medicineExpiry" required>
                                            <div class="mb-3"></div>
                                        </div>
                                        <div class="mb-3">
                                            <div class="mb-3"><label class="medQuantity" for="medQuantity">Quantity</label><input class="form-control" type="number" id="medicineQuantity" name="medicineQuantity" required></div>
                                        </div>
                                        <div class="mb-3" style="resize: vertical;">
                                            <label class="medDetails" for="medicineDetails">Details</label>
                                            <textarea class="form-control" id="medicineDetails" name="medicineDetails" required></textarea>
                                        </div>
                                        <div class="mb-3"><label class="medicinePhoto" for="medicinePhoto">Upload Photo<input class="form-control" type="file" id="medicinePhoto" name="medicinePhoto" accept="image/*" required></label></div>
                                        <div class="mb-3">
                                            <label class="supplier" for="supplier">Select Supplier</label>
                                            <select class="form-control" id="supplier" name="supplier" required>
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = $result->fetch_assoc()) {
                                                        // Dynamic options generated from PHP
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-6 col-xl-12 offset-xl-0 button"><button class="btn btn-primary d-block w-100" type="submit">Add Medicine</button></div>
                                            </div>
                                        </div>
                                    </form>
                                </div>
